                ...
                <div class="row">
                    ...
                    <div class="col-md-4 wow animated fadeInUp">
                        <div class="price-table featured text-center">
                            ...
                            <div class="value">
                                <span></span>
                                <span><!--PreviousDateBegin-->03/03/17<!--PreviousDateEnd--></span><br>
                                <span><!--PreviousDateLongBegin-->Friday March 03 (2:15-3:30)<!--PreviousDateLongEnd--></span>
                            </div>
                            <ul>
                                <li><!--PreviousTopicBegin-->Topic: Post-OregonCTF Celebration<!--PreviousTopicEnd--></li>
                                <li><!--PreviousLeaderBegin-->Leader: N/A<!--PreviousLeaderEnd--></li>
                                <li><!--PreviousDescriptionBegin-->Description: Celebrating 4th place in OregonCTF<!--PreviousDescriptionEnd--></li>
                                <li><!--PreviousHomeworkBegin-->Homework: N/A<!--PreviousHomeworkEnd--></li>
                                <li><!--PreviousDownloadBegin--><a href="downloads/03-03-17"><!--PreviousDownloadEnd-->Downloads</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 wow animated fadeInUp" data-wow-delay="0.4s">
                        <div class="price-table featured text-center">
                            ...
                            <div class="value">
                                <span></span>
                                <span><!--NextDateBegin-->03/07/17<!--NextDateEnd--></span><br>
                                <span><!--NextDateLongBegin-->Tuesday March 07 (2:15-3:30)<!--NextDateLongEnd--></span>
                            </div>
                            <ul>
                                ...
                                <li><!--NextDownloadBegin--><a href="downloads/03-07-17"><!--NextDownloadEnd-->Downloads</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 wow animated fadeInUp" data-wow-delay="0.8s">
                        <div class="price-table featured text-center">
                            ...
                            <div class="value">
                                <span></span>
                                <span><!--FutureDateBegin-->03/09/17<!--FutureDateEnd--></span><br>
                                <span><!--FutureDateLongBegin-->Thursday March 09 (2:15-3:30)<!--FutureDateLongEnd--></span>
                            </div>
                            <ul>
                                ...
                                <li><!--FutureDownloadBegin--><a href="downloads/03-09-17"><!--FutureDownloadEnd-->Downloads</a></li>
                            </ul>
                        </div>
                    </div>
