                ...
                <div class="row">
                    ...
                    <div class="col-md-4 wow animated fadeInUp">
                        <div class="price-table featured text-center">
                            ...
                            <div class="value">
                                <span></span>
                                <span><!--PreviousDateBegin-->03/07/17<!--PreviousDateEnd--></span><br>
                                <span><!--PreviousDateLongBegin-->Tuesday March 07 (2:15-3:30)<!--PreviousDateLongEnd--></span>
                            </div>
                            <ul>
                                <li><!--PreviousTopicBegin-->Topic: Learning SageMath<!--PreviousTopicEnd--></li>
                                <li><!--PreviousLeaderBegin-->Leader: Dane Miller<!--PreviousLeaderEnd--></li>
                                <li><!--PreviousDescriptionBegin-->Description: Learning to use SageMath to solve crypto problems<!--PreviousDescriptionEnd--></li>
                                <li><!--PreviousHomeworkBegin-->Homework: N/A<!--PreviousHomeworkEnd--></li>
                                <li><!--PreviousDownloadBegin--><a href="downloads/03-07-17"><!--PreviousDownloadEnd-->Downloads</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 wow animated fadeInUp" data-wow-delay="0.4s">
                        <div class="price-table featured text-center">
                            ...
                            <div class="value">
                                <span></span>
                                <span><!--NextDateBegin-->03/09/17<!--NextDateEnd--></span><br>
                                <span><!--NextDateLongBegin-->Thursday March 09 (2:15-3:30)<!--NextDateLongEnd--></span>
                            </div>
                            <ul>
                                ...
                                <li><!--NextDownloadBegin--><a href="downloads/03-09-17"><!--NextDownloadEnd-->Downloads</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 wow animated fadeInUp" data-wow-delay="0.8s">
                        <div class="price-table featured text-center">
                            ...
                            <div class="value">
                                <span></span>
                                <span><!--FutureDateBegin-->03/10/17<!--FutureDateEnd--></span><br>
                                <span><!--FutureDateLongBegin-->Friday March 10 (2:15-3:30)<!--FutureDateLongEnd--></span>
                            </div>
                            <ul>
                                <li><!--FutureTopicBegin-->Topic: TBD<!--FutureTopicEnd--></li>
                                <li><!--FutureLeaderBegin-->Leader: TBD<!--FutureLeaderEnd--></li>
                                <li><!--FutureDescriptionBegin-->Description: The next meeting has yet to be determined. Check back soon!<!--FutureDescriptionEnd--></li>
                                <li><!--FutureHomeworkBegin-->Homework: TBD<!--FutureHomeworkEnd--></li>
                                <li><!--FutureDownloadBegin--><a href="downloads/03-10-17"><!--FutureDownloadEnd-->Downloads</a></li>
                            </ul>
                        </div>
                    </div>
